...
@tools.nottest
class BaseTestInputRDMUtilsParallel:
    ...
    def test_calc_input_rdm_shape(self):
        in_rdm = input_rdm_utils.calc_input_rdm(self.fpath_acts, key=self.key, do_keep_mem_low=True)
        # print(in_rdm)
...
@tools.istest
class TestInputRDMUtilsParallel(BaseTestInputRDMUtilsParallel):
    ...
    def test_calc_input_rdm_values_offdiag(self):
        in_rdm = input_rdm_utils.calc_input_rdm(self.fpath_acts, key=self.key,
                                                do_keep_mem_low=True)
        assert_almost_equals(in_rdm[0, 1], 0, places=15)
        assert_almost_equals(in_rdm[0, 2], 2, places=15)
        assert_almost_equals(in_rdm[0, 3], 2, places=15)
        assert_almost_equals(in_rdm[1, 2], 2, places=15)
        assert_almost_equals(in_rdm[1, 3], 2, places=15)
    ...
    def test_calc_and_save_input_rdm_do_triu_true_values_offdiag(self):
        ...
        assert_equal(in_rdm.size, self.num_samples * (self.num_samples - 1) / 2)
        assert_almost_equals(in_rdm[0], 0, places=15)
        assert_almost_equals(in_rdm[1], 2, places=15)
        assert_almost_equals(in_rdm[2], 2, places=15)
        assert_almost_equals(in_rdm[3], 2, places=15)
        assert_almost_equals(in_rdm[4], 2, places=15)


@tools.istest
class TestInputRDMUtilsHDF5Parallel(TestInputRDMUtilsParallel):
...
@tools.istest
class TestInputRDMUtils2DParallel(BaseTestInputRDMUtilsParallel):
...
@tools.istest
class TestInputRDMUtils2DHDF5Parallel(TestInputRDMUtils2DParallel):
